export const mockCategories = [
    ...
    resources: [
      {
        id: 'cli-plugin',
        title: 'Vue CLI 插件开发',
        link: 'https://cli.vuejs.org/zh/dev-guide/plugin-dev.html',
        completed: false,
      },
  ...
  },
  {
    ...
    resources: [
      { id: 'element-source', title: 'Element 源码解析', link: 'https://github.com/ElemeFE/element', completed: false },
      {
        id: 'storybook',
        title: 'Storybook 入门',
        link: 'https://storybook.js.org/tutorials/intro-to-storybook/vue/zh-CN/get-started/',
        completed: false,
      },
    ],
  },
  ...
  },
  {
    ...
    resources: [
      ...
      { id: 'cursor-mcp', title: 'Cursor MCP 集成文档', link: 'https://docs.cursor.com/mcp', completed: false },
      {
        id: 'ai-collaboration',
        title: 'AI 辅助协同最佳实践',
        link: 'https://www.figma.com/community/file/1234567890-ai-design-workflow',
        completed: false,
      },
    ],
  },
  {
    ...
    resources: [
      {
        id: 'cdn-best-practice',
        title: 'CDN 最佳实践',
        link: 'https://developer.fastly.com/solutions/examples/caching/',
        completed: false,
      },
      { id: 'image-optimization', title: '图片优化与缓存策略', link: 'https://web.dev/image-cdns/', completed: false },
      {
        id: 'cloudflare-images',
        title: 'Cloudflare Images 教程',
